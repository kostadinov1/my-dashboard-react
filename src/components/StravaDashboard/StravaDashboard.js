                        ...
                        <div className="single-new-trend mg-t-30">
                            ...
                            <div className="overlay-content">
                                ...
                                <div className="product-action">
                                    <ul>
                                        <li>
                                            <a data-toggle="tooltip" title="Shopping" href="/">A<i className="fa fa-shopping-bag" aria-hidden="true"></i></a>
                                        </li>
                                        <li>
                                            <a data-toggle="tooltip" title="Quick view" href="/">A<i className="fa fa-heart" aria-hidden="true"></i></a>
                                        </li>
                                    </ul>
                                </div>
                                <a href="/">
                        ...
                        <div className="personal-info-wrap">
                            ...
                            <div className="widget-text-box">
                                ...
                                <div className="text-right like-love-list">
                                    ...
                                    <a href="/" className="btn btn-xs btn-primary"><i className="fa fa-heart"></i> Love</a>
                                </div>
                            </div>
                        </div>
                    </div>
